import { LayoutDashboard, PackagePlus, PackageSearch, User } from 'lucide-react'
...
const Sidebar = () => {
    return (
        <div className='hidden fixed md:block border-r bg-pink-50 border-pink-200 x-10 w-75 p-10 space-y-2 h-screen'>
            <div className='text-center pt-15 px-3 space-y-2'>
                ...
                <NavLink to='/dashboard/users' className={({ isActive }) => `text-xl ${isActive ? "bg-pink-600 text-gray-200" : "bg-transparent"} flex items-center gap-2 font-bold cursor-pointer p-3 rounded-2xl w-full`}><User /><span>Users</span></NavLink>
