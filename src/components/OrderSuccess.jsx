    ...
    return (
        <div className='min-h-screen flex items-center justify-center bg-gray-50 p-6'>
            <div className='bg-white rounded-2xl shadow-lg p-10 max-w-md w-full text-center'>
                ...
                {/* Title */}
                <h1 className='text-2xl font-bold mt-6 text-gray-800'>Payment Successfull 🎉</h1>
                ...
                <div className='mt-6 flex flex-col gap-3'>
                    ...
                    <button
                        ...
                        className='w-full border text-pink-600  py-3 rounded-xl hover:bg-pink-50 transition'
                    >
                        View My Orders
                    </button>
                </div>
