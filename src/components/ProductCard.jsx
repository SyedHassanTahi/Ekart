            ...
            <div className='w-full h-full aspect-square overflow-hidden'>
                {
                    ...
                    src={productImg[0]?.url} alt="" className='w-full h-full transition-transform duration-300 hover:scale-105' />
                }
            </div>
            {
                loading ? <div className='px-2 space-y-2 my-2'>
                    ...
                    <div className='px-2 space-y-1'>
                        ...
                        <Button
                            ...
                            className='bg-pink-600 mb-3 w-full'><ShoppingCart />Add to Cart</Button>
                    </div>
            }
        </div>
    )
